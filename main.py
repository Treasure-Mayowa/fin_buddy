...
BASE_URL = os.getenv("BASE_URL", "https://graph.facebook.com/v20.0")
...
app = FastAPI(title="WhatsApp Financial Guidance Bot")
...
async def handle_message(from_id: str, text: Optional[str], interactive: Optional[dict] = None):
    ...
    # Start / greeting
    if any(g in msg for g in GREETINGS) or msg in {"start", "menu"}:
